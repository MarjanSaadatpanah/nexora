...
const Hero = () => {
    return (
        ...
        <div className="flex py-2 lg:py-11">
            ...
            <div className="mr-auto place-self-center lg:col-span-8 flex justify-between w-full">
                <div>
                    ...
                    <h3 className="max-w-2xl mb-6 text-2xl tracking-tight leading-none md:text-3xl xl:text-3xl ">Make better decisions, faster</h3>
