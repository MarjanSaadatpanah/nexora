...
import ProjectsByCountryChart from './stats/ProjectsByCountryChart'
    ...
    return (
        ...
        <div className="grid max-w-screen-xl px-4 py-2 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div className="mr-auto place-self-center lg:col-span-8">
                ...
                <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl 400">
                    Discover and act on private market activity with <br /> predictive company intelligence.</p>
